...
async def cmsg(ctx):
    ...
    embed.add_field(name="TMP ver",value="[link](https://clips.twitch.tv/FunGracefulSparrowRaccAttack-qeFSem4jpPlkoXzi)",inline=False)
    embed.add_field(name="king_kelp CSM comment",value="[link](https://clips.twitch.tv/FitSpoopyTaroNerfBlueBlaster-Wkn_pDhjjTQ1P98p)",inline=False)
    embed.add_field(name="MySong abney reaction",value="[link](https://clips.twitch.tv/StylishWittyPigANELE-XqeuXk2RjskQSS1f)",inline=False)
