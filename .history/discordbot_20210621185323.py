...
@bot.command()
async def tt(ctx):
    embed = discord.Embed(title="kazn's TimeTrials list",description="kaznの",url = "Kazn's Time Trials playlist:https://youtube.com/playlist?list=PLdGKAlqxxNI4oOn7v2LppK5j_oYJH7Lrf",color=0xff0000)
    await ctx.send(embed=embed)
